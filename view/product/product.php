                ...
                <div class="col-md-12">
                    <div class="pagination">
                        ...
                        for ($i=1; $i < $totalpage+1; $i++) { 
                            ...
                            if($i==$page){
                                echo '<a href="index.php?ctrl=product&page=product&idcatalog='.$iddm.'&trang='.$i.'" class="active">'.$i.'</a>';
                            }else{
                                echo '<a href="index.php?ctrl=product&page=product&idcatalog='.$iddm.'&trang='.$i.'">'.$i.'</a>';
                            }
